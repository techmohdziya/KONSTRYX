...
service ProjectService @(path:'/project') {
  ...
  @Aggregation.ApplySupported : {
    ...
    AggregatableProperties : [
      ...
      { $Type : 'Aggregation.AggregatablePropertyType', Property : billedGross },
      { $Type : 'Aggregation.AggregatablePropertyType', Property : retentionHeld },
      { $Type : 'Aggregation.AggregatablePropertyType', Property : netCertified },
      { $Type : 'Aggregation.AggregatablePropertyType', Property : cashIn },
      { $Type : 'Aggregation.AggregatablePropertyType', Property : cashInCum },
      { $Type : 'Aggregation.AggregatablePropertyType', Property : cashOutSigned },
      { $Type : 'Aggregation.AggregatablePropertyType', Property : netMonthly },
      { $Type : 'Aggregation.AggregatablePropertyType', Property : cumPosition },
    ],
