...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("SupplierInvoicesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheSupplierInvoicesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheSupplierInvoicesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheSupplierInvoicesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheSupplierInvoicesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheSupplierInvoicesListGenerated.onTable().iPressRow(0);
            Then.onTheSupplierInvoicesObjectPageGenerated.iSeeThisPage();
