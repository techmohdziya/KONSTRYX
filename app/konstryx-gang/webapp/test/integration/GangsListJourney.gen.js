...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("GangsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheGangsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheGangsListGenerated.onFilterBar().iChangeSearchField("Search Term");
