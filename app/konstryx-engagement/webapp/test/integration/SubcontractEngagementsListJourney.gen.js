...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("SubcontractEngagementsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheSubcontractEngagementsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheSubcontractEngagementsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheSubcontractEngagementsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheSubcontractEngagementsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheSubcontractEngagementsListGenerated.onTable().iPressRow(0);
            Then.onTheSubcontractEngagementsObjectPageGenerated.iSeeThisPage();
