...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("HolidayCalendarsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheHolidayCalendarsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheHolidayCalendarsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheHolidayCalendarsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheHolidayCalendarsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheHolidayCalendarsListGenerated.onTable().iPressRow(0);
            Then.onTheHolidayCalendarsObjectPageGenerated.iSeeThisPage();
