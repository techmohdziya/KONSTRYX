...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ResourcesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheResourcesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheResourcesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheResourcesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheResourcesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheResourcesListGenerated.onTable().iPressRow(0);
            Then.onTheResourcesObjectPageGenerated.iSeeThisPage();
