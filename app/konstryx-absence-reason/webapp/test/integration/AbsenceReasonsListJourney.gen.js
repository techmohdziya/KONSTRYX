...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AbsenceReasonsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheAbsenceReasonsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheAbsenceReasonsListGenerated.onFilterBar().iChangeSearchField("Search Term");
