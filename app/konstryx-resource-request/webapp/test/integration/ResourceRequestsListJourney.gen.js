...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ResourceRequestsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheResourceRequestsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheResourceRequestsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheResourceRequestsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheResourceRequestsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheResourceRequestsListGenerated.onTable().iPressRow(0);
            Then.onTheResourceRequestsObjectPageGenerated.iSeeThisPage();
