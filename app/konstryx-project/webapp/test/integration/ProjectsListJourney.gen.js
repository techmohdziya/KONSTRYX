...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheProjectsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheProjectsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheProjectsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheProjectsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheProjectsListGenerated.onTable().iPressRow(0);
