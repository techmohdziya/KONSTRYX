...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ReservationsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheReservationsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheReservationsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheReservationsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheReservationsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheReservationsListGenerated.onTable().iPressRow(0);
            Then.onTheReservationsObjectPageGenerated.iSeeThisPage();
