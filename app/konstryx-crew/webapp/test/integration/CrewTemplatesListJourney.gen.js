...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("CrewTemplatesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheCrewTemplatesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheCrewTemplatesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheCrewTemplatesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheCrewTemplatesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheCrewTemplatesListGenerated.onTable().iPressRow(0);
            Then.onTheCrewTemplatesObjectPageGenerated.iSeeThisPage();
