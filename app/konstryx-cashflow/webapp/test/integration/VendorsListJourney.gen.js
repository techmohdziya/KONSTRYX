...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("CashflowListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheCashflowListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheCashflowListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheCashflowListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheCashflowListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheCashflowListGenerated.onTable().iPressRow(0);
            Then.onTheCashflowObjectPageGenerated.iSeeThisPage();
