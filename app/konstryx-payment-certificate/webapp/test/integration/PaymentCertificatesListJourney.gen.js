...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PaymentCertificatesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onThePaymentCertificatesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePaymentCertificatesListGenerated.onFilterBar().iChangeSearchField("Search Term");
