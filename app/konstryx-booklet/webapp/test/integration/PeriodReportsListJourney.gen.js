...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PeriodReportsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onThePeriodReportsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePeriodReportsListGenerated.onFilterBar().iChangeSearchField("Search Term");
