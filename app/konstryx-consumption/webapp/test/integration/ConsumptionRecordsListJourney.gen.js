...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ConsumptionRecordsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheConsumptionRecordsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheConsumptionRecordsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheConsumptionRecordsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheConsumptionRecordsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheConsumptionRecordsListGenerated.onTable().iPressRow(0);
            Then.onTheConsumptionRecordsObjectPageGenerated.iSeeThisPage();
