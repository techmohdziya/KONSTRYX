...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("BOQsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheBOQsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheBOQsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheBOQsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheBOQsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheBOQsListGenerated.onTable().iPressRow(0);
            Then.onTheBOQsObjectPageGenerated.iSeeThisPage();
