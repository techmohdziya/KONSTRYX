...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AbsencesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheAbsencesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheAbsencesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheAbsencesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheAbsencesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheAbsencesListGenerated.onTable().iPressRow(0);
            Then.onTheAbsencesObjectPageGenerated.iSeeThisPage();
