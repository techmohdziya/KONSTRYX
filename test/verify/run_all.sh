...
SUITES="test_foundations test_approval test_persona_approver test_attachments test_variants test_project test_p6 test_rates test_boq test_chain test_planning test_budget test_distribution test_procurement"
