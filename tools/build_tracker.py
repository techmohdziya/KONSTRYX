...
items = [
    ...
    ("B-01f", "Business", "Masters — object pages", "Drill into a single master to view and edit; the pattern every later module reuses", "Not started", "—", "Next in Masters"),
    ("B-01g", "Business", "Masters — productivity and consumption norms", "Screens plus seed data; norms drive derived consumption and earned value", "Not started", "—", "After object pages"),
