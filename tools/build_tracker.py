...
items = [
    ...
    ("B-01c", "Business", "Masters — validation rules", "Hierarchy integrity (L5 parent must be L4), code uniqueness within scope, rate effective-dating overlaps", "Not started", "—", "Next"),
    ("B-01d", "Business", "Masters — remaining entities + UI", "CBS library, productivity and consumption norms, templates under the same scope treatment; Masters screens", "Not started", "—", "After validation"),
