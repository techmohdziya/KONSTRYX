...
decisions = [
    ...
    ("D-19", "2026-08-15", "Flexible approval workflow on every object", "Your instruction. Extends the approval framework already modelled from budgets to all masters and transactions, with the workflow configurable rather than coded", "You", "High — the schemes exist; the engine, the inbox and the per-object wiring do not", "Decided"),
]
