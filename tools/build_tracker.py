...
suggestions = [
    ...
    ("S-33", "Planning", "Spec variance needs a distinct CBS leaf", "Recipes are keyed on the leaf, so two BOQ items on one leaf get one build-up. A leaf carrying both M40 and M50 is unresolvable. This is CBS library governance, not schema — the coverage report is where a missing distinction shows up", "Write the rule into the CBS library stewardship guidance", "Open", "2026-08-15"),
