...
items = [
    ...
    ("B-01e", "Business", "Masters — screens", "List and object pages for resource hierarchy, CBS library, rates and norms, plus the promotion queue", "Not started", "—", "Next; needs the launchpad shell decision already taken (D-16)"),
