...
items = [
    ...
    ("PS-03", "Project Setup", "Primavera P6 project import", "Rides on the upload framework (D-18); creates the project and its WBS in one file", "Not started", "—", "Next in Project Setup"),
